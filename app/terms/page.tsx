...
const sections = [
  ...
  {
    title: "4. 제휴 및 수수료 고지",
    body: "후쿠오사카는 마이리얼트립, 아고다 등 제휴사와의 제휴 링크를 통해 항공권, 숙소, 투어·티켓, eSIM 등 여행 관련 상품 정보를 제공할 수 있습니다.\n\n사용자가 후쿠오사카 내 제휴 링크를 통해 외부 제휴 플랫폼에서 예약 또는 구매를 진행하는 경우, 후쿠오사카는 해당 제휴사로부터 일정 수수료를 지급받을 수 있습니다.\n\n이러한 제휴 수수료는 사용자가 부담하는 상품 가격에 별도로 추가되지 않으며, 실제 상품 가격, 예약 조건, 취소·환불 정책은 각 제휴 플랫폼 및 판매자의 기준을 따릅니다.",
  },
  {
    title: "5. 사용자의 의무",
