      ...
      <div className="grid grid-cols-2 gap-2.5">
        {items.map((item) => (
          <Link
            ...
            className="group relative min-h-[118px] rounded-[22px] border border-[#f0e0d8] bg-white px-3.5 py-3 shadow-[0_12px_24px_rgba(115,72,59,0.06)] transition active:scale-[0.99]"
          >
            ...
            <h3 className="mt-2.5 whitespace-nowrap text-[14px] font-black leading-5 tracking-[-0.05em] text-[#2c211d]">
              {item.miniTitle}
            </h3>
            <p className="mt-1 text-[12px] font-black tracking-[-0.04em] text-[#f05f5b]">
              {item.miniBudgetLabel}
            </p>
            <p className="mt-1.5 text-[11px] font-semibold tracking-[-0.03em] text-[#8d7c74]">
